/**
 * $Author: $ $Rev: $ $Date:: 2012-06-05 15:14:56#$:
 *
...
public interface OrgManagerDirect {
     ...
     * @throws BusinessException
     */
    void deleteRelsInList(List<Long> sourceIds, final String key) throws BusinessException;
    ...
    void addRole2Entity(Long roleId, Long unitId, V3xOrgEntity entity, List<V3xOrgRelationship> delRels,
        List<V3xOrgRelationship> addRels) throws BusinessException;

    void addRole2Entity(Long roleId, Long accountId, V3xOrgEntity entity, V3xOrgDepartment deptvo,
     ...
     * @throws BusinessException
     */
    void insertRepeatSortNum(String entityClassName, Long accountId, Long sortNum, Boolean isInternal)
        throws BusinessException;
    ...
    /**
     * 批量增加单位 步骤：1、校验 数据 2、操作符合条件的实体 3、触发事件
     * 
     * @param accounts
     * @return OrgManagerMessage
     * @throws BusinessException
    ...
    /**
     * 政务版---增加职级 步骤：1、校验 数据 2、操作符合条件的实体 3、触发事件
     * 
     * @param dutyLevel
     * @return OrgManagerMessage
     * @throws BusinessException
    ...
    /**
     * 政务版——批量增加职级 步骤：1、校验 数据 2、操作符合条件的实体 3、触发事件
     * 
     * @param dutyLevels
     * @return OrgManagerMessage
     * @throws BusinessException
    ...
    /**
     * 政务版——修改职级 步骤：1、校验 数据 2、操作符合条件的实体 3、触发事件
     * 
     * @param level
     * @return OrgManagerMessage
     * @throws BusinessException
    ...
    /**
     * 政务版——批量修改职级 步骤：1、校验 数据 2、操作符合条件的实体 3、触发事件
     * 
     * @param levels
     * @return OrgManagerMessage
     * @throws BusinessException
    ...
    /**
     * 政务版--删除职级 步骤：1、校验 数据 2、操作符合条件的实体 3、触发事件
     * 
     * @param level
     * @return OrgManagerMessage
     * @throws BusinessException
    ...
    /**
     * 政务版--批量删除职级 步骤：1、校验 数据 2、操作符合条件的实体 3、触发事件
     * 
     * @param levels
     * @return OrgManagerMessage
     * @throws BusinessException
    ...
    /**
     * 增加人员 步骤：1、校验 数据 2、操作符合条件的实体 3、触发事件<br>
     ...
     * @throws BusinessException
     */
    V3xOrgMember getMemberByLoginName(String loginName, boolean includeDisabled) throws BusinessException;
     ...
     * @since 3.12
     */
    List<V3xOrgTeam> getDepartmentTeam(Long depId, boolean includeDisabled) throws BusinessException;
     ...
     * @throws BusinessException
     */
    List<V3xOrgLevel> getAllLevels(Long accountId, boolean includeDisabled) throws BusinessException;
     ...
     * @return 单位人员列表
     */
    List<V3xOrgMember> getAllMembers(Long accountId, boolean includeDisabled) throws BusinessException;
     ...
     * @throws BusinessException
     */
    List<V3xOrgPost> getAllPosts(Long accountId, boolean includeDisabled) throws BusinessException;
     ...
     * @throws BusinessException
     */
    List<V3xOrgRole> getAllRoles(Long accountId, boolean includeDisabled) throws BusinessException;
     ...
     * @throws BusinessException
     */
    List<V3xOrgTeam> getAllTeams(Long accountId, boolean includeDisabled) throws BusinessException;
     ...
     * @throws BusinessException
     */
    List<V3xOrgMember> getMembersByLevel(Long levelId, boolean includeDisabled) throws BusinessException;
     ...
     * @throws BusinessException
     */
    List<V3xOrgMember> getMembersByPost(Long depId, Long postId, boolean includeDisabled) throws BusinessException;
     ...
     * @throws BusinessException
     */
    List<V3xOrgAccount> getAllAccounts(Boolean enable, Boolean isInternal, String condition, Object feildvalue,
     ...
     * 用于加密使用，返回单位名称<br>
     * 
     * @return 单组织版ID=670869647114347的单位的名称<br>
