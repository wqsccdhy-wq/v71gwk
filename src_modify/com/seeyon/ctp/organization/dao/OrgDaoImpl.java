...
/**
 * The DAO class for the entities: Department, Externalmember, Level, Member, Metadata, Orgaccount, Orgproperty,
 * Orgrelationship, Post, Team.
 */
public class OrgDaoImpl implements OrgDao {
    ...
    public List<OrgUnit> getAllUnitPO(OrgConstants.UnitType type, Long accountId, Boolean enable, Boolean isInternal,
    ...
    @Override
    public List<OrgUnit> getAllUnitPO0(UnitType type, Long accountId, Boolean enable, Boolean isInternal,
        ...
        if (StringUtils.isNotBlank(condition) && !"null".equals(condition)) {
            if (feildvalue instanceof String && !isEquals) {
                hql.append(" AND m.").append(condition)
    ...
    @Override
    public List<OrgUnit> getAllBusinessUnitPO(Long createrId, Boolean enable, String condition, Object feildvalue,
        FlipInfo flipInfo) {
        StringBuilder hql = new StringBuilder();
        Map<String, Object> params = new HashMap<String, Object>();
    ...
    public OrgUnit getV3xOrgUnitByPath(String path) {
        List<OrgUnit> unit = getAllUnitPO(null, null, null, null, "path", path, null);
        if (unit.size() == 0) {
            return null;
        } else {
            return unit.get(0);
    ...
    public List<OrgMember> getAllMemberPOByAccountId(Long accountId, Boolean isInternal, Boolean enable,
        ...
        if (param != null && param.containsKey("secPostId") && null != param.get("secPostId")) {
            ...
            return getAllMemberPOByAccountIdAndSecondPostId(accountId, secondPostId, isInternal, enable, param,
                flipInfo);
        }
        StringBuilder hql = new StringBuilder();
        Map<String, Object> params = new HashMap<String, Object>();
            ...
            for (Entry<String, Object> entry : paramSet) {
                ...
                if (StringUtils.isNotBlank(condition) && !"null".equals(condition)) {
                    if ("workLocal".equals(condition)) {
                        ...
                        hql.append(
                            " AND m.orgDepartmentId in (select d.id from OrgUnit as d WHERE (d.path like :dPath) AND d.type=:dType AND d.deleted=false AND d.orgAccountId=:dAccountId)");
                        ...
                        if ("loginName".equals(condition)) {
                            hql.append(" AND (p.").append(condition)
    ...
    public List<OrgMember> getAllMemberPOByAccountId(Long accountId, Integer type, Boolean isInternal, Boolean enable,
        String condition, Object feildvalue, FlipInfo flipInfo) {
    ...
    public Integer getAllMemberPONumsByAccountId(Long accountId, Integer type, Boolean isInternal, Boolean enable,
        ...
        hql.append(
            " m.deleted=false AND m.admin=false AND m.virtual=false AND m.assigned=true and (m.externalType!=1 and m.externalType!=2 and m.externalType!=3)");
    ...
    public List<OrgMember> getAllUnAssignedMember(Long accountId, FlipInfo flipInfo, Map beforeParams) {
        ...
        if (beforeParams != null && Strings.isNotEmpty((String)beforeParams.get("value"))) {
            ...
            if (beforeParams.size() > 0 && "orgAccountIdname".equals(beforeParams.get("condition"))) {
                ...
                params.put("orgAccountIdname",
                    "%" + SQLWildcardUtil.escape(String.valueOf(beforeParams.get("value"))) + "%");
            }
        }
        hql.append(" ORDER BY m.sortId ASC");
    ...
    public List<OrgMember> getAllMemberPOByDepartmentId(Long departmentId, boolean isCludChildDepart, Integer type,
    ...
    @Override
    public List<OrgMember> getAllMemberPOByDepartmentId(List<Long> departmentIds, Boolean isInternal, Boolean enable,
        Map<String, Object> param, FlipInfo flipInfo) {
        StringBuilder hql = new StringBuilder();
        Map<String, Object> params = new HashMap<String, Object>();
    ...
    public List<OrgMember> getAllMemberPOByDepartmentIds(List<Long> departmentIds, Integer type, Boolean isInternal,
    ...
    public List<OrgRole> getAllRolePO(Long accountId, Boolean enable, String condition, Object feildvalue,
        FlipInfo flipInfo) {
    ...
    public List<OrgRole> getAllRolePO(Long accountId, Boolean enable, Map<String, Object> param, FlipInfo flipInfo) {
        StringBuilder hql = new StringBuilder();
        Map<String, Object> params = new HashMap<String, Object>();
        ...
        if (param != null) {
            ...
            for (Entry<String, Object> entry : paramSet) {
                ...
                if (StringUtils.isNotBlank(condition) && !"accountId".equals(condition) && !"null".equals(condition)) {
                    ...
                    if (feildvalue instanceof List && "name".equals(condition)) {
                    ...
                    } else if (feildvalue instanceof String && !"bond".equals(condition) && !"type".equals(condition)
                        && !"enabled".equals(condition) && !"code".equals(condition)
                        ...
                        if ("enabled".equals(condition)) {
                            hql.append(" AND enable=:enable");
                            params.put("enable", Boolean.parseBoolean(String.valueOf(feildvalue)));
                        } else if ("sortId".equals(condition)) {
                            hql.append(" AND ").append(condition).append("=:" + condition);
                            params.put(condition, Long.parseLong(String.valueOf(feildvalue)));
                            ...
                            hql.append(" AND ").append(condition).append("=:" + condition);
                            params.put(condition, Integer.parseInt(String.valueOf(feildvalue)));
                        }
                    }
                }
            }
    ...
    public List<OrgTeam> getAllTeamPO(Long accountId, Integer type, Boolean enable, String condition, Object feildvalue,
        FlipInfo flipInfo) {
    ...
    public List<OrgPost> getAllPostPO(Long accountId, Boolean enable, String condition, Object feildvalue,
        FlipInfo flipInfo) {
    ...
    public List<OrgLevel> getAllLevelPO(Long accountId, Boolean enable, String condition, Object feildvalue,
        FlipInfo flipInfo) {
    ...
    public List<OrgRelationship> getOrgRelationshipPO(OrgConstants.RelationshipType type, Long sourceId, Long accountId,
    ...
    @Override
    public List<OrgRelationship> getOrgRelationshipPO4ConPost(String memberName, Long postId, Long accountId,
        ...
        if (memberName != null) {
            hql.append(" AND sourceId in (SELECT id FROM " + OrgMember.class.getSimpleName() + " WHERE name " + "like '"
                + "%" + SQLWildcardUtil.escape(memberName) + "%" + "'" + SQLWildcardUtil.setEscapeCharacter() + ") ");
        }
        if (postId != null) {
            hql.append(
                " AND sourceId in (SELECT id FROM " + OrgMember.class.getSimpleName() + " WHERE orgPostId =:postId ) ");
            params.put("postId", postId);
        }

        if (accountId != null) {
            hql.append(" AND sourceId in (SELECT id FROM " + OrgMember.class.getSimpleName()
                + " WHERE orgAccountId=:accountId ) ");
            params.put("accountId", accountId);
        }
        ...
        if (isSubUnitManage && subUnitIds.size() > 0) {
            hql.append(" AND (orgAccountId in(:subUnitId) or sourceId in (SELECT id FROM "
                + OrgMember.class.getSimpleName() + " WHERE orgAccountId in(:subUnitId)))");
    ...
    public OrgUnit getOrgUnitPOByPath(String path) {
        ...
        List lst = DBAgent.find("SELECT m FROM OrgUnit as m where m.path=:path", params);
    ...
    public void deleteOrgRelationshipPO(String type, Long sourceId, Long accountId,
        ...
        if (Strings.isBlank(type)) {
            ...
            List<V3xOrgRelationship> rels = orgCache.getV3xOrgRelationship(OrgConstants.RelationshipType.valueOf(type),
                sourceId, accountId, objectiveIds);
    ...
    @Override
    public <T extends V3xOrgEntity> void insertRepeatSortNum(Class<T> entityClass, Long accountId, Long sortNum,
        Boolean isInternal) {
    ...
    public <T extends V3xOrgEntity> void insertRepeatSortNum(Class<T> entityClass, Long accountId, Long sortNum,
        ...
        if (entityClass == V3xOrgAccount.class) {
            if (OrgConstants.ExternalType.Interconnect4.ordinal() == externalType && createrId != null) {
                DBAgent.bulkUpdate(
                    "UPDATE OrgUnit SET sortId=sortId + 1 WHERE type=? AND sortId>=? AND group = false and external_type=? and createrId=?",
                    OrgConstants.UnitType.Account.name(), sortNum, externalType, createrId);
                List<V3xOrgAccount> accounts =
                    this.orgCache.getAllV3xOrgEntityNoClone(V3xOrgAccount.class, null, externalType);
                ...
                DBAgent.bulkUpdate(
                    "UPDATE OrgUnit SET sortId=sortId + 1 WHERE type=? AND sortId>=? AND group = false and external_type=?",
                    OrgConstants.UnitType.Account.name(), sortNum, externalType);
                List<V3xOrgAccount> accounts =
                    this.orgCache.getAllV3xOrgEntityNoClone(V3xOrgAccount.class, accountId, externalType);
                for (V3xOrgAccount bo : accounts) {
                    if (bo.isGroup())
                        continue;
            ...
            DBAgent.bulkUpdate(
                "UPDATE OrgUnit SET sortId=sortId + 1 WHERE type=? AND orgAccountId=? AND sortId>=? and external_type=?",
                OrgConstants.UnitType.Department.name(), accountId, sortNum, externalType);
            List<V3xOrgDepartment> depts =
                this.orgCache.getAllV3xOrgEntityNoClone(V3xOrgDepartment.class, accountId, externalType);
            ...
            String hql =
                "UPDATE OrgMember SET sortId=sortId + 1 WHERE orgAccountId=? AND sortId>=? AND internal=? and external_type=?";
            if (selfEntityId != null) {
                hql = hql + " and id!=? ";
                DBAgent.bulkUpdate(hql, accountId, sortNum, isInternal, externalType, selfEntityId);
            } else {
                DBAgent.bulkUpdate(hql, accountId, sortNum, isInternal, externalType);
            }
            List<V3xOrgMember> members =
                this.orgCache.getAllV3xOrgEntityNoClone(V3xOrgMember.class, accountId, externalType);
            ...
            if (isInternal || externalType == 1) {
                String hql2 =
                    "UPDATE OrgRelationship SET sortId=sortId + 1 WHERE type=? AND objective5Id=? AND orgAccountId=? AND sortId>=?";
                if (selfEntityId != null) {
                    hql2 = hql2 + " and sourceId!=? ";
                    DBAgent.bulkUpdate(hql2, OrgConstants.RelationshipType.Member_Post.name(),
                        OrgConstants.MemberPostType.Main.name(), accountId, sortNum, selfEntityId);
                } else {
                    DBAgent.bulkUpdate(hql2, OrgConstants.RelationshipType.Member_Post.name(),
                        OrgConstants.MemberPostType.Main.name(), accountId, sortNum);
                }

                List<V3xOrgRelationship> rels =
                    this.orgCache.getV3xOrgRelationship(RelationshipType.Member_Post, null, accountId, null);
            ...
            DBAgent.bulkUpdate(
                "UPDATE OrgPost SET sortId=sortId + 1 WHERE orgAccountId=? AND sortId>=? and sortId < ? and external_type=?",
                accountId, sortNum, maxNum, externalType);
            ...
            DBAgent.bulkUpdate(
                "UPDATE OrgRole SET sortId=sortId + 1 WHERE orgAccountId=? AND sortId>=? and external_type=?",
                accountId, sortNum, externalType);
            ...
            DBAgent.bulkUpdate(
                "UPDATE " + entityClass.getSimpleName() + " SET sortId=sortId + 1 WHERE orgAccountId=? AND sortId>=?",
                accountId, sortNum);
        }
    ...
    public int getMaxOutternalDeptSortId(Long accountId) {
        ...
        String sql = null;
        sql =
            "SELECT max(sortId) FROM OrgUnit  WHERE type=:type AND deleted=false AND orgAccountId=:accountId AND internal=false";
    ...
    public int getExtMemberMaxSortId(Long accountId) {
        ...
        String sql = null;
        sql =
            "SELECT max(sortId) FROM OrgMember WHERE orgAccountId=:accountId AND deleted=false AND admin=false AND assigned=true AND internal=false";
        param.put("accountId", accountId);
        List lst = DBAgent.find(sql, param);
        if (!lst.isEmpty() && lst.get(0) != null) {
            return Integer.valueOf(lst.get(0).toString());
    ...
    public <T extends V3xOrgEntity> int getMaxSortId(Class<T> entityClass, Long accountId) {
        Map<String, Object> param = new HashMap<String, Object>();
        String sql = null;

        if (V3xOrgMember.class == entityClass) {
            sql =
                "SELECT max(sortId) FROM OrgMember WHERE orgAccountId=:accountId AND deleted=false AND admin=false AND enable=true AND assigned=true AND internal=true";
            param.put("accountId", accountId);
            ...
            sql =
                "SELECT max(sortId) FROM OrgUnit  WHERE type=:type AND deleted=false AND orgAccountId=:accountId AND internal=true";
            ...
            Class<? extends BasePO> poEntityClass = OrgHelper.boClassTopoClass(entityClass);
    ...
    public <T extends V3xOrgEntity> int getMaxSortId(Class<T> entityClass, Long accountId, int externalType,
        ...
        if (V3xOrgMember.class == entityClass) {
            sql =
                "SELECT max(sortId) FROM OrgMember WHERE orgAccountId=:accountId AND deleted=false AND admin=false AND enable=true AND assigned=true AND externalType=:externalType";
            param.put("accountId", accountId);
            param.put("externalType", externalType);
        } else if (V3xOrgDepartment.class == entityClass) {
            sql =
                "SELECT max(sortId) FROM OrgUnit  WHERE type=:type AND deleted=false AND orgAccountId=:accountId AND externalType=:externalType";

            param.put("type", OrgConstants.UnitType.Department.name());
            param.put("accountId", accountId);
            param.put("externalType", externalType);
        } else if (V3xOrgAccount.class == entityClass
            && OrgConstants.ExternalType.Interconnect4.ordinal() == externalType && createrId != null) {
            sql =
                "SELECT max(sortId) FROM OrgUnit  WHERE type=:type AND deleted=false AND createrId=:createrId AND externalType=:externalType";
    ...
    @Override
    public <T extends V3xOrgEntity> boolean isPropertyDuplicated(Class<T> entityClass, String property, Object value) {
    ...
    public <T extends V3xOrgEntity> boolean isPropertyDuplicated(Class<T> entityClass, String property, Object value,
        ...
        if (V3xOrgAccount.class == entityClass) {
            sql = "SELECT count(*) from OrgUnit WHERE type=:type AND deleted=false AND " + property
                + "=:Porperty and externalType = :externalType";
            ...
            sql = "SELECT count(*) FROM OrgVisitor WHERE  " + property + "=:Porperty";

            param.put("Porperty", value);
        } else {
            Class<? extends BasePO> poEntityClass = OrgHelper.boClassTopoClass(entityClass);

            sql = "SELECT count(*) FROM " + poEntityClass.getSimpleName() + " where deleted=false AND " + property
                + "=:Porperty and externalType = :externalType";
            param.put("Porperty", value);
            param.put("externalType", externalType);
        }
    ...
    public <T extends V3xOrgEntity> boolean isPropertyDuplicated(Class<T> entityClass, String property, Object value,
        ...
        return isPropertyDuplicated(entityClass, property, value, accountId, entId,
            OrgConstants.ExternalType.Inner.ordinal());
    }
    ...
    public <T extends V3xOrgEntity> boolean isPropertyDuplicated(Class<T> entityClass, String property, Object value,
        ...
        if (V3xOrgAccount.class == entityClass) {
            if (OrgConstants.ExternalType.Interconnect4.ordinal() == externalType && createrId != null) {
                sql = "SELECT count(*) FROM OrgUnit WHERE type=:type AND deleted=false AND " + property
                    + "=:Porperty AND id !=:entId and externalType = :externalType and createrId = :createrId";
            ...
            if (OrgConstants.ExternalType.Interconnect4.ordinal() != externalType) {
                sql = "SELECT count(*) FROM OrgUnit WHERE type=:type AND deleted=false "
                    + " AND internal = (SELECT internal FROM OrgUnit WHERE id =:entId )" + " AND " + property
                    + "=:Porperty AND id !=:entId ";
                ...
                if (OrgConstants.ExternalType.Interconnect1.ordinal() == externalType
                    || OrgConstants.ExternalType.Interconnect2.ordinal() == externalType) {
            ...
            sql += " AND virtual=false AND assigned=true AND " + property
                + "=:Porperty AND id !=:entId and externalType = :externalType";
    ...
    public <T extends V3xOrgEntity> boolean isPropertyDuplicated(Class<T> entityClass, String property, Object value,
        ...
        if (V3xOrgAccount.class == entityClass) {
            sql = "SELECT count(*) FROM OrgUnit WHERE type=:type AND deleted=false AND " + property + "=:Porperty";
    ...
    public void updateRelationship(OrgRelationship orgRelationshipPO) {
        ...
        List<OrgRelationship> orgRelationshipPOs = new ArrayList<OrgRelationship>(1);
    ...
    public List<OrgRole> getBaseRole() {
        StringBuilder hql = new StringBuilder();
        Map<String, Object> params = new HashMap<String, Object>();
        hql.append(" FROM " + OrgRole.class.getSimpleName() + " WHERE 1=1 ");
    ...
    public List<PrivRoleMenu> getRoleMenu(OrgRole orgrole) {
        ...
        hql_r.append(" FROM " + PrivRoleMenu.class.getSimpleName() + " WHERE 1=1 ");
    ...
    @Override
    public List<OrgRelationship> getOrgRelationshipPOByMembers(RelationshipType type, List<Long> sourceIds,
        Long accountId, EnumMap<RelationshipObjectiveName, Object> objectiveIds, FlipInfo flipInfo) {
        StringBuilder hql = new StringBuilder();
        Map<String, Object> params = new HashMap<String, Object>();
    ...
    @Override
    public List<OrgRelationship> getOrgRelationshipPOByAccountsAndMembers(RelationshipType type, List<Long> sourceIds,
    ...
    @Override
    public List<OrgRelationship> getOrgRelationshipPOByMemberName(String name, FlipInfo flipInfo, String openFrom,
        ...
        hql.append(
            " WHERE r.type = 'Member_Post' AND r.objective5Id = 'Concurrent' AND r.sourceId in (SELECT m.id from OrgMember as m where m.name like :name "
                + SQLWildcardUtil.setEscapeCharacter() + ")");
        params.put("name", "%" + SQLWildcardUtil.escape(name) + "%");

        if ("subUnitManage".equals(openFrom) && subUnitIds.size() > 0) {
            hql.append(" AND (r.orgAccountId in(:subUnitId) or r.sourceId in (SELECT id FROM "
                + OrgMember.class.getSimpleName() + " WHERE orgAccountId in(:subUnitId)))");
            params.put("subUnitId", subUnitIds);
        }
    ...
    @Override
    public List<OrgTeam> getAllTeamPO(Long accountId, Integer type, Boolean enable, Map<String, Object> param,
        FlipInfo flipInfo) {
        ...
        if (param != null) {
            ...
            if ((param.size() == 1) && param.containsKey("Member")) {
                ...
                sql.append(
                    "select t2 from OrgRelationship t1, OrgTeam t2 where t1.sourceId = t2.id and t2.deleted =:deleted and t1.type =:type");
                sql.append(
                    " and t1.objective6Id =:teamMeberType and t1.objective0Id =:teamMemberId ORDER BY t2.sortId ASC ");
    ...
    @Override
    public List<OrgMember> getAllMemberPOByAccountIdAndSecondPostId(Long accountId, Long secondPostId,
    ...
    @Override
    public List<BasePO> getDisableEntityPO(String entityClassName, Long accountId, String condition,
        Object feildvalue) {
        StringBuilder hql = new StringBuilder();
        Map<String, Object> params = new HashMap<String, Object>();
        hql.append("SELECT m from ");
        String h = "";
        if (entityClassName.equals(V3xOrgLevel.class.getSimpleName())) {
            h = OrgLevel.class.getSimpleName()
                + " as m where (m.deleted=true or (m.deleted=false and m.enable=false)) ";
        } else if (entityClassName.equals(V3xOrgMember.class.getSimpleName())) {
            h = OrgMember.class.getSimpleName()
                + " as m where m.admin=false and (m.deleted=true or (m.deleted=false and m.enable=false))  and externalType=0 ";
        } else if (entityClassName.equals(V3xOrgPost.class.getSimpleName())) {
            h = OrgPost.class.getSimpleName()
                + " as m where (m.deleted=true or (m.deleted=false and m.enable=false))  and externalType=0  ";
        } else if (entityClassName.equals(V3xOrgRole.class.getSimpleName())) {
            h = OrgRole.class.getSimpleName()
                + " as m where (m.deleted=true or (m.deleted=false and m.enable=false))  and externalType=0 ";
        } else if (entityClassName.equals(V3xOrgTeam.class.getSimpleName())) {
            h = OrgTeam.class.getSimpleName()
                + " as m where (m.deleted=true or (m.deleted=false and m.enable=false))  and externalType=0 ";
        } else if (entityClassName.equals(V3xOrgAccount.class.getSimpleName())) {
            h = OrgUnit.class.getSimpleName()
                + " as m where m.type=:type and (m.deleted=true or (m.deleted=false and m.enable=false))  and externalType=0 ";
            params.put("type", OrgConstants.UnitType.Account.name());
        } else if (entityClassName.equals(V3xOrgDepartment.class.getSimpleName())) {
            h = OrgUnit.class.getSimpleName()
                + " as m where m.type=:type and (m.deleted=true or (m.deleted=false and m.enable=false))  and externalType=0";
        ...
        if (StringUtils.isNotBlank(condition) && !"null".equals(condition)) {
            if (feildvalue instanceof String) {
                hql.append(" AND ").append(SQLWildcardUtil.likeLowerCase("m." + condition))
                    .append(" LIKE :feildvalue " + SQLWildcardUtil.setEscapeCharacter());
                feildvalue = "%" + SQLWildcardUtil.escape(String.valueOf(feildvalue)).toLowerCase() + "%";
            } else {
                hql.append(" and m.").append(condition).append("=:feildvalue");
