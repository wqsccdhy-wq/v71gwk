...
public class FormPresetManagerImpl implements FormPresetManager {
		...
		if(Strings.isNotEmpty(formList)) {
			...
			for(GovForm oldForm : formList) {
				...
				for(GovFormElement oldElement : formElementList) {
					GovElement element  = elementManager.getElementByElementId(String.valueOf(oldElement.getElementId()), formPO.getAppType(), domainId);
					//element = elementManager.getElementByFieldName(formPO.getAppType(), element.getFieldName(), domainId);
				...
				List<GovFormFlowPermBound> formPermissionBoundList = govformPermissionBoundManager.findFormPermissionBoundListByFormId(oldForm.getId());
	...
	public void setGovformPermissionBoundManager(
			FormPermissionBoundManager govformPermissionBoundManager) {
	...
	public void setGovformExtendInfoManager(
			FormExtendInfoManager govformExtendInfoManager) {
