...
public class AddressBookSet extends BasePO {
    ...
    private boolean 		  memberSecondPost = true;				   //副岗
    ...
    public boolean isGender() {
        String displayColumn = this.getDisplayColumn();
        if (Strings.isNotBlank(displayColumn)) {
            return displayColumn.contains("gender");
        }
        return gender;
    }
    ...
    public void setMemberSecondPost(boolean memberSecondPost) {
        this.memberSecondPost = memberSecondPost;
    }
    public boolean isMemberSecondPost() {
        String displayColumn = this.getDisplayColumn();
        if (Strings.isNotBlank(displayColumn)) {
            return displayColumn.contains("memberSecondPost");
        }
        return memberSecondPost;
    }
