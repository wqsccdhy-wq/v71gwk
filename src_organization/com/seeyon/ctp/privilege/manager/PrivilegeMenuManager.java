...
public interface PrivilegeMenuManager {
	...
	/**
	 * 
	 * @Title: getBusinessMenusByAccountId 
	 * @Description: 为M3增加接口 获取单位下所有业务菜单
	 * @param @param accountId
	 * @param @return
	 * @param @throws BusinessException  
	 * @return Set<PrivMenuBO>   
	 * @throws
	 */
	 ...
	 * @throws BusinessException
	 */
	Map<Long, PrivMenuBO> getMenusByResource(List<String> resourceCodes)throws BusinessException;
