...
public class DistributeManagerImpl implements DistributeManager {
    ...
    public FlipInfo showDistributeList(FlipInfo fi, Map params) throws BusinessException {
        ...
        for (Object object : list) {
            ...
            if (Strings.isNotEmpty(m.get("orgAccountId"))) {
            ...
            if (Strings.isNotEmpty(m.get("orgDepartmentId"))) {
            ...
            m.put("orgPostIdname", "");
            if (Strings.isNotEmpty(m.get("orgPostId"))) {
            ...
            if (Strings.isNotEmpty(m.get("orgLevelId"))) {
