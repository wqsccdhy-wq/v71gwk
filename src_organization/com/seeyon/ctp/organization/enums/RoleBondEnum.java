...
public enum RoleBondEnum implements EnumsCode {
    ...
    backflag(0, ResourceUtil.getString("role.group")), 
    accountflag(1, ResourceUtil.getString("role.unit")), 
    departmentflag(2, ResourceUtil.getString("role.dept"));

    private int    key;
    private String text;

    RoleBondEnum(int key, String text) {
        this.key = key;
        this.text = text;
    }
