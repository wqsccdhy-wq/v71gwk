...
import com.seeyon.v3x.peoplerelate.enums.RelationType;
...
public interface PeopleRelateManager {
     ...
     * @return
     */
    public Long getRelateETagDate(Long memberId);

    /**
     *关联人员有变化时更新时间时间戳
     * @param memberId 人员ID
     */
    public void updateRelateETagDate(Long memberId);
...
//	取得我的关联人员列表
	...
	//获取与当前人关联的某人员信息
	public PeopleRelate getPeopleRelate(Long relateId,Long relatedId) throws BusinessException;
	 ...
	 * @throws Exception
	 */
	public Map<RelationType, List<V3xOrgMember>> getAllRelateMembersWithFix(Long userId) throws Exception;
    ...
    public String getDeptMeMberForAjax(Long deptId,Long userId);
}